...
class ReturnsApi
{
     ...
     */
    public function rootPost($return_order = null)
    {
        list($response) = $this->rootPostWithHttpInfo($return_order);
        return $response;
    }
     ...
     */
    public function rootPostWithHttpInfo($return_order = null)
    {
        $request = $this->rootPostRequest($return_order);
     ...
     */
    public function rootPostAsync($return_order = null)
    {
        return $this->rootPostAsyncWithHttpInfo($return_order)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rootPostAsyncWithHttpInfo($return_order = null)
    {
        $returnType = '\Dhl\Rest\Retoure\Model\ReturnOrderConfirmation';
        $request = $this->rootPostRequest($return_order);
     ...
     */
    public function rootPostRequest($return_order = null)
    {
        ...
        if (isset($return_order)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($return_order));
            } else {
