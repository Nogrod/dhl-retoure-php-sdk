...
class CustomsDocumentPosition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['position_description'] = $data['position_description'] ?? null;
        ...
        $this->container['article_reference'] = $data['article_reference'] ?? null;
        $this->container['tarif_number'] = $data['tarif_number'] ?? null;
    }
    ...
    {
        if (!is_null($tarif_number) && (mb_strlen($tarif_number) > 8)) {
        ...
        if (!is_null($tarif_number) && (mb_strlen($tarif_number) < 0)) {
