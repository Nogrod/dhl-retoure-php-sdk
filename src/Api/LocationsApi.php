...
class LocationsApi
{
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Dhl\Rest\Retoure\Model\Receiver[]|\Dhl\Rest\Retoure\Model\JSONStatus, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
