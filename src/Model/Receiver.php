...
class Receiver implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['contact_email']) && (mb_strlen($this->container['contact_email']) > 80)) {
    ...
    public function setContactEmail(?string $contact_email): static
    {
        ...
        if ((mb_strlen($contact_email) > 80)) {
            throw new InvalidArgumentException('invalid length for $contact_email when calling Receiver., must be smaller than or equal to 80.');
        }
