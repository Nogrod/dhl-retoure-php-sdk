...
class ReturnOrderConfirmation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'sstatus' => '\Dhl\Rest\Retoure\Model\JSONStatus',
        'shipment_no' => 'string',
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['qr_link']) && (mb_strlen($this->container['qr_link']) < 0)) {
            $invalidProperties[] = "invalid value for 'qr_link', the character length must be bigger than or equal to 0.";
        }
     ...
     * Gets sstatus
     *
     * @return \Dhl\Rest\Retoure\Model\JSONStatus
     */
    public function getSstatus(): \Dhl\Rest\Retoure\Model\JSONStatus
    {
     ...
     * Sets sstatus
     *
     * @param \Dhl\Rest\Retoure\Model\JSONStatus $sstatus sstatus
     *
     * @return $this
     */
    public function setSstatus(\Dhl\Rest\Retoure\Model\JSONStatus $sstatus): static
    {
        if (is_null($sstatus)) {
     ...
     * Sets qr_link
     *
     * @param string|null $qr_link Deep link to import the QR Code to the Post & DHL App
     *
     * @return $this
     */
    public function setQrLink(?string $qr_link): static
    {
        if (is_null($qr_link)) {
            throw new InvalidArgumentException('non-nullable qr_link cannot be null');
        }

        if ((mb_strlen($qr_link) < 0)) {
            throw new InvalidArgumentException('invalid length for $qr_link when calling ReturnOrderConfirmation., must be bigger than or equal to 0.');
        }
